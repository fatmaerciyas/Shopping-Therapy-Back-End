...
namespace BusinessLayer.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public async Task<GeneralIdentityDto> RegisterAsync(RegisterDto registerDto)
        {
            ...
            {
                newUser.PasswordHash = registerDto.Password;
            }
        ...
        public async Task<UserInfoResult?> GetUserDetailsByUserId(string Id)
        {
        ...
        public async Task<GeneralIdentityDto> UpdateUserAsync(ClaimsPrincipal User, UpdateUserDto updateUserDto)
        {
            ...
            var newuser = new ApplicationUser
            {
                ...
                Roles = updateUserDto.Roles.ToList(),
            };
        ...
        public async Task<GeneralIdentityDto> DeleteUser(UserInfoResult user)
        {
            if (user is null)
            {
                return new GeneralIdentityDto()
